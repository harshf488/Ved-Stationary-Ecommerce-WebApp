...
const createRazorpayOrder = async (orderData, onSuccess, onError) => {
  try {
    ...
    const response = await fetch('https://server-2-vz2t.onrender.com/create-order/api', {
      method: 'POST',
      headers: {
...
const body = {
 ...
 const validateRes = await fetch("https://server-2-vz2t.onrender.com/create-order/validate" ,{ 
